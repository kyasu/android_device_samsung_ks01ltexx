...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/libnfc-nci-20791b04.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-nci-20791b04.conf \
    $(LOCAL_PATH)/configs/libnfc-nci-20791b05.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-nci-20791b05.conf
